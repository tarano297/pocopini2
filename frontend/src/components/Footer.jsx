        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4 space-x-reverse">
              <a href="https://www.instagram.com/invites/contact/?utm_source=ig_contact_invite&utm_medium=copy_link&utm_content=zyt8v4k" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/10 hover:bg-pink-600 rounded-full flex items-center justify-center transition-all duration-300 transform hover:scale-110" title="اینستاگرام">
              ...
              <a href="https://pin.it/Vruj0K01e" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/10 hover:bg-red-600 rounded-full flex items-center justify-center transition-all duration-300 transform hover:scale-110" title="Pinterest">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* اطلاعات تماس */}
          <div>
            <h3 className="text-xl font-bold mb-6 text-white">تماس با ما</h3>
            <div className="space-y-4">
              ...
              <div className="flex items-start">
                <div className="w-10 h-10 bg-pink-600/20 rounded-lg flex items-center justify-center ml-3 flex-shrink-0">
